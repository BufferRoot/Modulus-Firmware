...
Source: [vercel-labs/opensrc](https://github.com/vercel-labs/opensrc) — install: `npm install -g opensrc`
...
## Modulus / Zig port examples

```bash
opensrc path ziglang/zig@0.16.0
opensrc path espressif/esp-idf@v6.0.1
opensrc path espressif/esp-hosted
opensrc path m5stack/M5Unified
rg "nvs_" $(opensrc path espressif/esp-idf)/components/nvs_flash/
```
